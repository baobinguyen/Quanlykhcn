package vn.duytan.core.data.daoimpl;
...
public class AbstractDao<ID extends Serializable, T> implements GenericDao<ID,T> {
    ...
    public Object[] findbyProperty(String property, Object value, String sortExpresion, String sortDirection) {
        List<T> list = new ArrayList<T>();
        Session session = HibernateUtil.getSessionFactory().openSession();
        Transaction transaction = session.beginTransaction();
        Object totalItem = 0;
        try {
            ...
            if (sortExpresion != null && sortDirection != null){
                sql1.append(" order by ").append(sortExpresion);
